...
function PhoneComponent(props) {
    ...
    const totalTransactions =data.totalTranscations;
    const numberOfClients = data.numberOfClients;
    const transactionsByIndustry = data.transactionsByIndustry;
    const topAccounts = data.topAcounts;

    const graph1 = forIndustryBar(transactionsByIndustry);
    const graph2 = forAccountsBar(topAccounts);
