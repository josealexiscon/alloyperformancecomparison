# Looker Extension AlloyPerformanceComparison

AlloyPerformanceComparison is a Looker extension using React and JavaScript.
...
5. Create a `manifest` file
   ...
   ```
    ...
    application: AlloyPerformanceComparison {
        label: "AlloyPerformanceComparison React/JavaScript extension"
